...
const Contact = () => {
  return (
    <section className="flex justify-center items-center py-12 bg-green-900 min-h-screen">
      <div className="flex bg-green-800 rounded-xl overflow-hidden max-w-4xl w-full">
        ...
        <div className="p-8 w-1/2 text-white flex flex-col justify-center">
          <h2 className="text-3xl font-bold mb-4">Your Trusted Singapore Food Consultancy</h2>
          <p className="mb-6">
            We specialise in guiding companies through the intricate landscape of global B2B sales, Singapore Government and industry relations, global regulatory landscapes, food and nutrition industry trends, product innovation and leadership development.
          </p>
          <p className="mb-6">
          ...
          <button className="mt-4 px-4 py-2 border border-green-500 text-green-500 rounded hover:bg-green-700 hover:text-white transition">CONTACT</button>
        </div>
      </div>
    </section>
  );
